	...
	return (
		<nav className="flex w-full justify-between py-8 px-8">
			...
			<div className="md:flex items-center gap-4 hidden ">
				<Link href="#features" className="text-lg hover:text-gray-500">
					Features
				</Link>
				<Link href="#pricing" className="text-lg hover:text-gray-500">
					Pricing
				</Link>
				<Link href="#testimonials" className="text-lg hover:text-gray-500">
					Testimonials
				</Link>
